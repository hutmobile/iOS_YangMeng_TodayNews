...
class DongtaiCommentCell: UITableViewCell, RegisterCellOrNib {
    ...
    var comment = DongtaiComment() {
        didSet {
            ...
            if comment.user_auth_info != "" { authInfoLabel.text = comment.userAuthInfo!.auth_info }
            if comment.user_profile_image_url != "" {
                ...
                if comment.user.user_auth_info != "" { authInfoLabel.text = comment.user.userAuthInfo!.auth_info }
            }
