...
class DongtaiCollectionViewCell: UICollectionViewCell, RegisterCellOrNib {
    ...
    var largeImage: LargeImageList? {
        didSet {
            thumbImageView.kf.setImage(with: URL(string: largeImage!.url), placeholder: nil, options: nil, progressBlock: { (receivedSize, totalSize) in
