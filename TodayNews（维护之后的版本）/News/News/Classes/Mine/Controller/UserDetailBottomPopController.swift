...
class UserDetailBottomPopController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var UDChildren = [BottomTabChildren]()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let child = childViewControllers[indexPath.row]
        cell.textLabel?.text = child.nibName
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        didSelectedChild?(UDChildren[indexPath.row])
    }
